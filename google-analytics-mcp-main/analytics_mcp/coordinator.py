...
from analytics_mcp.tools.reporting.activity import (
    get_activity_report,
    _get_activity_report_description,
)
...
get_activity_report_with_description = FunctionTool(get_activity_report)
get_activity_report_with_description.description = (
    _get_activity_report_description()
)
...
tools = [
    ...
    get_activity_report_with_description,
]
...
for tool in mcp_tools:
    ...
    elif tool.name == "get_activity_report":
        tool.inputSchema["required"] = [
            "property_id",
            "start_date",
            "end_date",
